...
> ⚠️ **2026-07-12 当前有效待办（覆盖下方旧池）**：[`docs/plans/audio-speaker-aware-result-page-2026-07-12.md`](plans/audio-speaker-aware-result-page-2026-07-12.md) 已完成，等待用户验收反馈。重点是区分说话人总结；遇到计划外事实必须停下来问用户。下方历史任务池勿直接捡起执行。
