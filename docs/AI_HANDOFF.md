...
- **执行计划**：[`docs/plans/audio-speaker-aware-result-page-2026-07-12.md`](plans/audio-speaker-aware-result-page-2026-07-12.md)，当前 `status: in_progress`。
...
- **当前下一步**：P0-E 将音频结果页与 NoteBi 统一笔记能力合并，并接入新建总结的“总结方式”选择；若涉及 schema/迁移或发现调用关系超出计划，先停下确认。
