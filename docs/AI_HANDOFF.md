...
## 当前执行指针（2026-07-29，计划已确认）

- **当前任务**：项目清理、功能盘点和产品确认已完成；按 [`plans/2026-07-29-feature-completion-short-term.md`](plans/2026-07-29-feature-completion-short-term.md) 从 S0 开始串行执行。
...
1. S0 修正规则文档中的旧音乐/提示词契约，并删除“风格报告”入口。
2. S1 重新实现批次生命周期；不得合并或 cherry-pick 整个 WIP 分支。
